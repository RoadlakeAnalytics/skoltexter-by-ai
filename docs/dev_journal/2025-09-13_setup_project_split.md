# 2025-09-13 — Uppdelning av `setup_project.py`

Datum: 2025-09-13

Författare: Automatiserad refaktorering (utförd av utvecklare/CI)
...
### Pipeline‑lagret (`src/setup/pipeline/`):
...
## Patchlista (viktigaste filer skapade/ändrade)
